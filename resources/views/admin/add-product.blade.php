        ...
        <div class="editor-container">
            <div class="editor-right">
                <div class="editor-in">
                    ...
                    <img src="" alt="" id="product_cover_preview">
                </div>
                {{-- <div class="editor-in">
                    <label for="editor-name">其他照片</label>
                    <input type="file" name="product_images[]" id="editor-other-imgs" class="editor-input" value="" multiple="multiple">
                ...
                <div class="editor-in">
                    ...
                    <textarea type="text" name="product_description" id="editor-description" class="editor-input" value="" rows="8"></textarea>
                </div>
                <div class="editor-in">
                ...
                <div class="editor-in">
                    ...
                    <input type="text" name="product_promo_price" id="editor-promo-price" class="editor-input" value="">
                </div>
            </div>
            <div class="editor-right">
                <div class="editor-in">

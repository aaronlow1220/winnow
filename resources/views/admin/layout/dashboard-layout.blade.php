...
<head>
    ...
    <link rel="icon" href="{{ asset('assets/img/favi.svg') }}" />
    <link rel="stylesheet" href="{{ asset('assets/css/admin/font.css') }}" />
    <link rel="stylesheet" href="{{ asset('assets/css/admin/reset.css') }}" />
    <link rel="stylesheet" href="{{ asset('assets/css/admin/navs.css') }}" />
                ...
                <div class="sb-content">
                    ...
                    <div class="sb-content-manager sb-category-gap">
                        ...
                        <ul class="sb-content-manager-article-child sb-category-subcat">
                            <a href="latest-news-list.html">
                                <li>最新消息</li>
                            </a>
                            <a href="dishes-list.html">
                                <li>忠貞美食</li>
                            </a>
                            <a href="attractions-list.html">
                                <li>忠貞景點</li>
                            </a>
                            <a href="">
                                <li>忠貞夢想</li>
                    ...
                    <div class="sb-ecommerce-manager">
                        ...
                        <div class="sb-ecommerce-manager-category sb-category-parent sb-category-top-margin">
                            ...
                            <a href="order-list.html"
                                class="sb-ecommerce-manager-article-text sb-category-main-title">訂單管理</a>
                        </div>
                        <div class="sb-ecommerce-manager-category sb-category-parent sb-category-top-margin">
                            <div class="sb-ecommerce-manager-article-logo">
                                <svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 -960 960 960"
                            ...
                            <a href="product-list.html"
                                class="sb-ecommerce-manager-article-text sb-category-main-title">商品管理</a>
                        </div>
                    </div>
                </div>
            </div>

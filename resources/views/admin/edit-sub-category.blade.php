...
@section('dashboard-content')
    <form class="func" action="{{ route('handle.editSubCategory') }}" method="POST">
        ...
        @endif
        <input type="hidden" name="subCategory" value="{{ $subCategories->uuid }}">
        <div class="func-bar">
            ...
            <div class="editor-right">
                ...
                <div class="editor-in">
                    ...
                    <select name="status" id="editor-status" class="editor-input">
                        <option value="ACTIVE" @if ($subCategories->status == 'ACTIVE') selected @endif>公開</option>
                        <option value="UNLISTED" @if ($subCategories->status == 'UNLISTED') selected @endif>不公開</option>
                        <option value="PRIVATE" @if ($subCategories->status == 'PRIVATE') selected @endif>私人</option>
                    </select>
                </div>
            </div>
        </div>

                    ...
                    <div class="dashboard">
                        <div class="dashboard-top">
                            <div class="dashboard-title">
                                <p class="dashboard-title-sub">文章管理</p>
                                <p class="dashboard-title-main">最新消息</p>
                            </div>
                            <div class="dashboard-top-func">
                                <input type="text" />
                        ...
                        <div class="dashboard-function-bar">
                            <div class="dashboard-fb-fn">
                                <a href="latest-news-add.html" class="dashboard-fb-fn-btn">
                                    <svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 -960 960 960" width="24">
                                        <path d="M440-440H200v-80h240v-240h80v240h240v80H520v240h-80v-240Z" />
                                    </svg>
                                    <p>新增文章</p>
                                </a>
                                <div class="dashboard-fb-fn-btn dropbtn" onclick="toggleDropdown()">
                                    <svg class="dropbtn" xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 -960 960 960" width="24">
                                        <path
                                            d="M480-160q-33 0-56.5-23.5T400-240q0-33 23.5-56.5T480-320q33 0 56.5 23.5T560-240q0 33-23.5 56.5T480-160Zm0-240q-33 0-56.5-23.5T400-480q0-33 23.5-56.5T480-560q33 0 56.5 23.5T560-480q0 33-23.5 56.5T480-400Zm0-240q-33 0-56.5-23.5T400-720q0-33 23.5-56.5T480-800q33 0 56.5 23.5T560-720q0 33-23.5 56.5T480-640Z"
                                        />
                                    </svg>
                                    <p class="dropbtn">更多動作</p>
                        ...
                        <div class="dashboard-list">
                            <table class="dashboard-list-table">
                                <thead>
                                    <tr>
                                        <th><input type="checkbox" class="checkmark" name="" id="master-checkmark" /></th>
                                        <th>標題</th>
                                        <th>狀態</th>
                                        <th>作者</th>
                                        <th>建立時間</th>
                                ...
                                <tbody>
                                    <tr>
                                        <td class="dashboard-lt-checkbox"><input type="checkbox" class="checkmark" name="" id="" /></td>
                                        <td class="dashboard-lt-title">
                                            <div class="dashboard-lt-title-container">
                                                <a
                                                    class="dashboard-lt-title-link"
                                                    href=""
                                                    title="忠貞仙樂飄飄 - 手碟音樂表演哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈"
                                                >
                                                    忠貞仙樂飄飄 -
                                                    手碟音樂表演哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈
                                                </a>
                                            </div>
                                            <div class="dashboard-lt-category-container">
                                                <p>分類:</p>
                                                <span>活動資訊</span>
                                            </div>
                                        </td>
